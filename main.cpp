...
int main() {
    ...
    tester* backtrack_tester = new tester("Backtrack", 20);
    ...
    tester* rec_backtrack_tester = new tester("Recursive backtrack", 20);
    ...
    tester* greedy_tester = new tester("Greedy", 20);
    ...
    tester* dynamic_tester = new tester("Dynamic", 20);
